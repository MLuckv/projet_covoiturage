 ...
 */
final class Version20230530084956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE place CHANGE voyage_id voy_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE place CHANGE voy_id voyage_id INT DEFAULT NULL');
